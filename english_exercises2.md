...
<p style="color:gold">新功能：将鼠标悬浮在（或点击）带<span style="text-indent: 0px" class="tooltip">点式下划线<span style="text-indent: 0px" class="tooltiptext">就是这样</span></span>的文字上时，会出现对应的中文翻译。</p>
